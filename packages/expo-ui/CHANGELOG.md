...
- [android] Added the Jetpack Compose `RangeSlider` component with support for colors, limits, steps, and custom thumb and track slots. (by [@felipe-software](https://github.com/felipe-software))
